...
func main() {
	...
	flag.StringVar(&inspectorOptions.AuthTokenFile, "auth-token-file", inspectorOptions.AuthTokenFile, "If specified, token used to authenticate to Image Inspector will be read from this file")
